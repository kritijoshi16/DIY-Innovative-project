...
const ViewProduct = () => {
  ...
  return (
    <div className=''>
      ...
      <Link to={"/ProductListing"}> <button className='bttn btn-outline-primary rounded-pill px-3 my-4'><i className=" px-2 bi bi-arrow-left-circle"></i>Products</button></Link>
            ...
            <div className="card my-4 shadow">
              <div className="row my-5">
                ...
                <div className="col-md-6">
                  <h1 className='fw-bold py-2' style={{color:"teal", fontFamily:"initial"}}>{productList.name}</h1>
                  <h1 className='fw-bold ' style={{color:"teal", fontFamily:"initial"}}><i className="bi bi-currency-rupee fw-bold "></i>{productList.price}</h1>
                  <p className='py-3' style={{color:"teal", fontFamily:"initial"}}> {productList.longdescription}</p>
